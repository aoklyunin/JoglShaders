package misc.combiner;

import com.fasterxml.jackson.annotation.JsonCreator;
import com.fasterxml.jackson.annotation.JsonIgnore;
import com.fasterxml.jackson.annotation.JsonProperty;
import com.sun.istack.NotNull;
import misc.combiner.ranges.EmptyRange;
import misc.combiner.ranges.Range;
import misc.combiner.ranges.RangeBuilder;
import misc.combiner.ranges.complex.CombinerRange;
import misc.combiner.ranges.complex.ListRange;
import misc.combiner.ranges.primitive.*;
import misc.combiner.ranges.vector.Vector2iRange;
...
public class Combiner {
    ...
    public LinkedList<Integer> getEnabledRangeNumbers() {
        // создаём список разрешённых параметров
    ...
    @Override
    public int hashCode() {
        int result = combinationCnt != null ? combinationCnt.hashCode() : 0;
        result = 31 * result + (combinationLoopPos != null ? combinationLoopPos.hashCode() : 0);
        result = 31 * result + (ranges != null ? ranges.hashCode() : 0);
        result = 31 * result + (rangeDict != null ? rangeDict.hashCode() : 0);
        return result;
    }
