...
public class GLConsole {
     ...
     */
    public GLConsole(@NotNull GLConsole glConsole) {
     ...
     */
    public GLConsole(@NotNull GLTextController textController, @NotNull WorldParams worldParams) {
        this.renderStartCnt = worldParams.getRenderConsoleTickCnt();
        this.maxLineCnt = worldParams.getMaxConsoleLinesCnt();
    ...
    public boolean equals(Object o) {
        ...
        GLConsole glConsole = (GLConsole) o;
