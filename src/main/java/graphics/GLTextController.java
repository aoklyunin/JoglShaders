...
public class GLTextController {
     ...
     * @param color цвет текста
     */
    public void drawText(@NotNull String text, @NotNull Vector2d pos, @NotNull Vector4d color) {
     ...
     * @param color цвет текста
     */
    public void drawText(@NotNull String text, @NotNull Vector2i pos, @Nullable Vector4d color) {
